// Type definitions for atatus-spa.js
// Project: https://github.com/atatus/atatus-spa
...
interface AtatusOptions {
    ...
    /** Similar to ignoreDomains, but will ignore performance metrics from whole urls patching a regex pattern. */
    ignoreDomains?: (RegExp | string)[];
